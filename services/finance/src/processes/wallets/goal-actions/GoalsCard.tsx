...
import { useGoalsBrowser } from "@feature/wallets";
import { NewGoalPanel } from "@process/wallets/goal-actions/NewGoalPanel.tsx";
import { DeleteGoalDialog } from "@process/wallets/goal-actions/DeleteGoalDialog.tsx";
import { ListFilterBar, ListPager, RowDeleteButton } from "@shared/components";
import { GoalSkeletonRow } from "@entity/wallets";
import { GoalRow } from "@widget/wallets/goal/GoalRow.tsx";

import { GOALS_PAGE_SIZE, GOALS_STATUS_OPTIONS } from "@widget/wallets/config.ts";
