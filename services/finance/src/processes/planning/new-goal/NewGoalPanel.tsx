...
import { sanitizeAmountInput, useDisclosure } from "@shared/utils";
import { SlideOver, DisclosureTrigger, FieldLabel } from "@shared/components";

import { EMOJI_OPTIONS } from "@widget/planning/config";
...
const NewGoalPanel: FC<NewGoalPanelProps> = ({ children }) => {
	...
	return (
		<>
			...
			<SlideOver open={open} onClose={close} title="New goal">
