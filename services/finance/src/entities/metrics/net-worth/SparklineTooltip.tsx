...
const SparklineTooltip: FC<SparklineTooltipProps> = ({ x, y, onLeft, valueFormatted, isNow, diffPositive, diffFormatted, ago }) => createPortal(
	<div
		className={cn(
...
export type { SparklineTooltipProps };
