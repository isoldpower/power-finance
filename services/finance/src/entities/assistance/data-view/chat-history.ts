...
const compareSentAt = (left: string, right: string): number => {
...
const compareTurns = (left: AssistantMessage, right: AssistantMessage): number => {
...
const chatHistory = (messages: AssistantMessage[]): AssistantMessage[] => (
