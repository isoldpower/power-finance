...
import { AiAssistantPanel, SparkleIcon } from "@entity/planning";
import { MOCK_SIGNALS, MOCK_CHAT, MOCK_PROMPTS } from "@feature/planning";
			...
			{open ? createPortal(
				<div className="finance-theme">
					...
					<div className="fixed inset-x-3 bottom-3 top-16 z-[41] flex animate-in slide-in-from-bottom duration-200">
						<AiAssistantPanel signals={MOCK_SIGNALS} chat={MOCK_CHAT} prompts={MOCK_PROMPTS} className="w-full" comingSoon onClose={() => { setOpen(false); }} />
					</div>
				</div>,
				document.body
			) : null}
