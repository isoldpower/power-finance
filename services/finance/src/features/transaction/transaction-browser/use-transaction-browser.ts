...
// Transactions table behaviour: search/wallet/type/sort filters (sort + wallet persisted in the
// URL), selection, row expansion and pagination. Presentation lives in the table entities.
