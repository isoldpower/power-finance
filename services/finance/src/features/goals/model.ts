...
// A long-term goal is a `long-term-goal` wallet; this is the presentation shape the
// planning UI consumes, derived from that wallet (balance = money saved so far).
interface Goal {
	id: string;
	icon: string;
	color: string;
...
export { walletToGoal, DEFAULT_GOAL_COLOR };
